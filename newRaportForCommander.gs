...
function buildEnemyLossesReport(brData) {
  ...
  var DIRS = ['Запорізький', 'Сумський', 'Харківський'];
  var destroyed = { 'Запорізький': {}, 'Сумський': {}, 'Харківський': {} };
  var damaged   = { 'Запорізький': {}, 'Сумський': {}, 'Харківський': {} };
